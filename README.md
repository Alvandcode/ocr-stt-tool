...
عکس یا PDF را انتخاب می‌کنی و متن فارسی/انگلیسی را در کادر پایین تحویل می‌گیری — بدون نصب هیچ‌چیز، پردازش داخل خود دستگاه:
...
> دفعه اول به اینترنت نیاز است تا موتور و داده زبان دانلود شود؛ فایل تو هیچ‌جا آپلود نمی‌شود.
> در هر اجرا حداکثر ۱۰ صفحه خوانده می‌شود — بازه صفحه (مثلاً ۱ تا ۱۰، ۱۱ تا ۲۰) را خودت بگذار.
...
چیدمان اصلی متن (سطرها و فاصله‌ها) به‌صورت پیش‌فرض حفظ می‌شود؛ با `--no-layout` به حالت قدیمی برمی‌گردی.
