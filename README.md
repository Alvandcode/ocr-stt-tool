نسخهٔ حرفه‌ای README را کامل‌تر می‌کنم و بخش‌های Star دادن و عضویت در کانال تلگرام را به‌صورت رسمی، شیک و استاندارد GitHub اضافه می‌کنم.  
همه‌چیز طبق ساختار READMEهای پروژه‌های بزرگ اوپن‌سورس نوشته شده است.
...
کانال رسمی: @acofficial (t.me in Bing)
